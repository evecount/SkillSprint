      ...
      <main className="pt-32 pb-32">
        ...
        <section id="path" className="py-32 mt-32 border-t-8 border-black bg-black text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-headline text-5xl font-black tracking-tighter uppercase italic mb-8">Identify Your Contribution</h2>
            <p className="max-w-2xl mx-auto text-white/60 font-bold mb-20 italic">The University of Life is a living exchange of human excellence. Wisdom flows in every direction.</p>
            ...
            <div className="grid gap-12 sm:grid-cols-3">
              ...
              <div className="p-8 border-4 border-white rounded-none hover:bg-secondary transition-colors group cursor-default">
                ...
                <p className="text-white/70 font-bold mb-8 italic">"I have lived it, and I am ready to share." Digitalize your legacy into a collaborative portal.</p>
              ...
              <div className="p-8 border-4 border-secondary rounded-none hover:bg-white transition-colors group cursor-default bg-secondary text-white hover:text-black">
                ...
                <h3 className="text-2xl font-black uppercase mb-4 tracking-tight text-white group-hover:text-black italic">Source Student</h3>
                <p className="text-white group-hover:text-black font-bold mb-8 italic">"I want to learn and contribute." Master the craft while teaching your mentor something new.</p>
              ...
              <div className="p-8 border-4 border-white rounded-none hover:bg-secondary transition-colors group cursor-default">
                ...
                <h3 className="text-2xl font-black uppercase mb-4 tracking-tight text-white italic">Registry Champion</h3>
                <p className="text-white/70 font-bold mb-8 italic">"I can bring lots more people." Orchestrate a wisdom ecosystem for your entire community.</p>
                <Button asChild variant="outline" className="w-full h-14 text-white border-white bg-transparent rounded-none hover:bg-white hover:text-black font-black uppercase tracking-widest italic">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-lg font-bold text-black/60 italic leading-relaxed">"The world doesn't need more hierarchies. It needs more shared sources of truth."</p>
            </div>
