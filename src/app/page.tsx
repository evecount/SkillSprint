...
import { ArrowRight, CheckCircle, Shield, Sparkles, Landmark, GraduationCap, Users, Zap } from 'lucide-react';
      ...
      <main className="pt-32 pb-32">
        ...
        <section className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-16 space-y-8">
            ...
            <h1 className="font-headline text-6xl md:text-9xl font-black tracking-tighter text-foreground leading-[0.85] max-w-5xl uppercase italic">
              Bypass the gatekeepers. <span className="text-secondary">Master the craft.</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground font-bold max-w-3xl leading-relaxed italic">
              Direct access to the practitioners who built the industries. In the University of Life, those who have done, can now teach. Join the symbiotic exchange of human excellence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-16 border-t-8 border-black">
            <div className="space-y-4 p-4 hover:bg-muted/30 transition-colors">
              ...
              <p className="text-sm font-bold text-muted-foreground italic">No fluff. No academics. Just practitioners who lived the career and are ready to share.</p>
            </div>
            <div className="space-y-4 p-4 hover:bg-muted/30 transition-colors">
              ...
              <h3 className="font-black uppercase tracking-tight text-2xl italic">Career Catalyst</h3>
              <p className="text-sm font-bold text-muted-foreground italic">Master the skills that institutional gatekeepers won't teach you. Transform your trajectory.</p>
            </div>
            <div className="space-y-4 p-4 hover:bg-muted/30 transition-colors">
              <div className="h-14 w-14 rounded-none bg-black flex items-center justify-center border-4 border-white shadow-none">
                <Shield className="h-7 w-7 text-white" />
              </div>
              <h3 className="font-black uppercase tracking-tight text-2xl italic">Lived Legacy</h3>
              <p className="text-sm font-bold text-muted-foreground italic">Masters finally own their intellectual property. Students gain a direct-from-source truth.</p>
            </div>
            <div className="space-y-4 p-4 hover:bg-muted/30 transition-colors">
              <div className="h-14 w-14 rounded-none bg-secondary flex items-center justify-center border-4 border-white shadow-none">
              ...
              <p className="text-sm font-bold text-muted-foreground italic">Join high-impact cohorts where students teach mentors and mentors architect careers.</p>
            </div>
          </div>
        </section>
        ...
        <section id="path" className="py-32 mt-32 border-t-8 border-black bg-black text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="max-w-2xl mx-auto text-white/60 text-xl font-bold mb-20 italic">A symbiotic ecosystem of human mastery. Identify how you will engage in the exchange.</p>
            ...
            <div className="grid gap-12 sm:grid-cols-3">
              ...
              <div className="p-10 border-8 border-white rounded-none hover:bg-secondary transition-colors group cursor-default">
                ...
                <p className="text-white/70 font-bold mb-10 italic">"I have lived it." Digitalize your legacy into a career-transforming portal for the next generation.</p>
                <Button asChild variant="outline" className="w-full h-16 text-xl text-white border-4 border-white bg-transparent rounded-none hover:bg-white hover:text-black font-black uppercase tracking-widest italic">
                  <Link href="/teacher/dashboard">Architect Legacy</Link>
                </Button>
              </div>
              ...
              <div className="p-10 border-8 border-secondary rounded-none hover:bg-white transition-colors group cursor-default bg-secondary text-white hover:text-black">
                ...
                <p className="text-white group-hover:text-black font-bold mb-10 italic">"I want direct mastery." Learn from the source and provide fresh perspective to the master.</p>
                <Button asChild className="w-full h-16 text-xl bg-black text-white rounded-none hover:bg-secondary font-black uppercase tracking-widest border-4 border-black italic">
                  <Link href="/learner/dashboard">Master the Craft</Link>
                </Button>
              </div>
              ...
              <div className="p-10 border-8 border-white rounded-none hover:bg-secondary transition-colors group cursor-default">
                ...
                <p className="text-white/70 font-bold mb-10 italic">"I can bring the community." Scale access to direct mastery for your organization or guild.</p>
                <Button asChild variant="outline" className="w-full h-16 text-xl text-white border-4 border-white bg-transparent rounded-none hover:bg-white hover:text-black font-black uppercase tracking-widest italic">
                  <Link href="/admin/dashboard">Champion Guilds</Link>
                </Button>
              </div>
            </div>
          </div>
