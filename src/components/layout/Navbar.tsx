...
import { Trophy, Home, BookOpen, BarChart2, User, Menu } from 'lucide-react';
        ...
        <div className="flex flex-1 justify-around md:flex-none md:justify-end md:gap-6">
          {!isAdmin ? (
            <>
              ...
              <div className="flex flex-col items-center gap-1 text-xs text-muted-foreground md:flex-row md:text-sm">
            ...
            <>
              ...
              <Link href="/admin/courses" className="flex flex-col items-center gap-1 text-xs text-muted-foreground hover:text-primary md:flex-row md:text-sm">
                <BookOpen className="h-5 w-5" />
                <span>Courses</span>
              </Link>
            </>
